...
All notable changes to the GreenDye for Training and Consultancy project will be documented in this file.
...
## V16
- Applied production hardening, CI, service-worker privacy controls, role fixes, documentation authority, build fixes, and updated tests.

## V17
- Unified acceptance gates, added finance behavior tests, centralized session-scoped token handling, and removed residual Academy forum surfaces from Green.

## V18
- Adopted GreenDye for Training and Consultancy as the sole brand; completed live Academy cleanup, credential terminology migration, production networking, MongoDB credential encoding, ClamAV refresh, integration CI, CSV import/export, and microscopic release gates.

## V19
- Microscopic repository cleanup: zero lint errors, structured backup logging, dead-code removal, current/legacy documentation separation, debug-log removal, import integrity checks, and V19 acceptance gates.

## V20
- Operational hardening and complete P0/P1 remediation from the V19 microscopic review.

## V21
- Repaired verification and bulk credential contracts, integration coverage, readiness checks, ClamAV startup resilience, and unused dependencies.

## V22
- Credential ownership, issuance integrity, bulk CSV alignment, atomic auditing, and public verification hardening.

## V23
- Strong public identifiers, required index migration, lifecycle state machine, full credential audit trail, soft deletion, and error-reporting hardening.

## V24
- Public verification privacy, migration consistency, equivalent-index handling, pagination, audit minimization, authenticated PDF download, archive transitions, and safer diagnostics.
