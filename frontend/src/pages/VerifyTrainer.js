...
const VerifyTrainer = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      setTrainer({ ...response.data.data, verificationStatus: response.data.status });
              ...
              {verified && trainer.verificationStatus === 'approved' && (
                ...
                >
                  ...
                  <Typography variant="body2" color="success.dark">
                    This trainer has been verified and approved by GreenDye for Training and Consultancy
                  </Typography>
                </Box>
              )}
            </CardContent>
