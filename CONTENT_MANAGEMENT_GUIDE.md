...
```json
{
  ...
  "data": {
    "homePage": {
      "heroTitle": {
        "en": "Welcome to GreenDye for Training and Consultancy",
...
This feature is part of the GreenDye for Training and Consultancy platform and follows the same license as the main project.
