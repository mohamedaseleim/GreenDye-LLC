...
async function sendEmailNotification(notification) {
  try {
        ...
        <mj-body>
          <mj-section>
            <mj-column>
              ...
              <mj-text font-size="12px" color="#666666">This is an automated message from GreenDye for Training and Consultancy. Please do not reply.</mj-text>
            </mj-column>
          </mj-section>
        </mj-body>
      </mjml>
    ...
    const mailOptions = {
      from: `"GreenDye for Training and Consultancy" <${process.env.SMTP_USER}>`,
      to: user.email,
      subject: emailTitle,
      html: htmlOutput
    };
