...
const SystemSettingsSchema = new mongoose.Schema({
  ...
  general: {
    siteName: {
      type: String,
      default: 'GreenDye for Training and Consultancy',
      trim: true
    },
    siteDescription: {
      type: String,
      default: 'Training and consultancy services, professional accreditation, and project delivery',
      trim: true
    },
    siteLogo: {
      type: String,
  ...
  emailTemplates: {
    ...
    serviceEngagement: {
      subject: {
        type: String,
        default: 'Service Engagement Confirmation'
      },
      body: {
        type: String,
        default: 'Your engagement {{engagementName}} has been confirmed'
      }
    },
    certificateIssued: {
      subject: {
      ...
      body: {
        type: String,
        default: 'Your verified credential {{credentialTitle}} is ready.'
      }
    }
  },
