...
## GreenDye for Training and Consultancy React Native Mobile App

This guide will help you set up and run the GreenDye for Training and Consultancy mobile application on iOS and Android devices.
...
{
  "name": "GreenDyeApp",
  "displayName": "GreenDye for Training and Consultancy",
  "version": "1.0.0",
  "ios": {
...
- [GreenDye for Training and Consultancy API Documentation](./NEW_FEATURES_API.md)
