...
This guide provides detailed instructions for integrating payment gateways with GreenDye for Training and Consultancy platform.

## Overview

GreenDye for Training and Consultancy supports multiple payment gateways to serve different regions:
