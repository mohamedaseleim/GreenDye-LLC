# GreenDye for Training and Consultancy Deployment Guide

This guide explains how to deploy the GreenDye for Training and Consultancy platform on a VPS with Ubuntu 22.04 and Hestia Control Panel v1.9.4.
